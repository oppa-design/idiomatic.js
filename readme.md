...
2. <a name="spacing">Beautiful Syntax</a>
    ...
    It's important to note that formatting preferences, such as "inner whitespace" should be considered optional, but only one style should exist across the entire source of your project. (we changed this in our fork) 
...
3. <a name="type">Type Checking (Courtesy jQuery Core Style Guidelines)</a>
    ...
    // You CAN`T preempt issues by using smart coercion with unary + or - operators:
...
7. <a name="misc">Misc</a>
	...
	You really need a switch? Think about it!
	
	tip: A switch statement is usually a sign that you could use polymorphism (http://tmont.com/blargh/2011/11/refactoring-a-switch-statement)
